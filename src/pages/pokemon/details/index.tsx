                ...
                <div className="flex flex-row justify-start items-center gap-10">
                    {
                        state.loadingDetails || !pokemon ?
                            ...
                            <div className="rounded-md w-full p-12" style={{ backgroundColor: pokemon.types ? getBgTypesColor(pokemon.types[0].type.name) : '#c1c1c1' }}>
                                <div className="flex sm:flex-col md:flex-row items-center gap-9 mb-7">
                                    {/* image */}
                                    <img
                                    ...
                                    <div className="flex flex-col justify-start gap-3 w-2/3">
                                        ...
                                        <div className="flex lg:flex-row md:flex-col sm:flex-col sm:w-full gap-4">
                                            {/* types */}
                                            <div className="flex flex-row justify-start items-center gap-2 bg-slate-100 p-5 rounded-md md:w-full">
